declare -a PRETRAINED_MODELS=("bert" "roberta" "mbert" "xlm")
declare -a DATASETS=("religion")
declare -a SPLIT_IDS=("1" "2" "3" "4" "5")

RESULTS_FOLDER="results_rel"
LANG_RESULTS_FOLDER="results_rel/en"
...
do
    ...
    do
        ...
        python scripts/compute_avg_scores_religion_en.py -I $CURR_BASE_FILEPATH -T $SOURCE_DATASET -N 5
    done
done